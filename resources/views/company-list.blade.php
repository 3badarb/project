                                        ...
                                        <div class="card-body px-4 py-5">
                                            ...
                                            <div class="mt-4">
                                                <a href="company-details.html"
                                                    class="primary-link">
                                                    <h6 class="fs-18 mb-2">Jobcy
                                                        Consulting</h6>
                                                </a>
                                                <p class="text-muted mb-4">New
                                                    York</p>
                                    ...
                                    <div class="card text-center mb-4">
                                        <div class="card-body px-4 py-5">
                                            ...
                                            <div class="mt-4">
                                                <a href="company-details.html"
                                                    class="primary-link">
                                                    <h6 class="fs-18 mb-2">Creative
                                                        Agency</h6>
                                                </a>
                                                <p class="text-muted mb-4">UK</p>
                                                <!-- <a href="company-details.html"
                                                    class="btn btn-primary">11
                                                    Opening Jobs</a> -->
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card text-center mb-4">
                                        <div class="card-body px-4 py-5">
                                            ...
                                            <div class="mt-4">
                                                <a href="company-details.html"
                                                    class="primary-link">
                                                    <h6 class="fs-18 mb-2">DootTech
                                                        Solution</h6>
                                                </a>
                                                <p class="text-muted mb-4">London</p>
                                                <!-- <a href="company-details.html"
                                                    class="btn btn-primary">09
                                                    Opening Jobs</a> -->
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card text-center mb-4">
                                        <div class="card-body px-4 py-5">
                                            ...
                                            <div class="mt-4">
                                                <a href="company-details.html"
                                                    class="primary-link">
                                                    <h6 class="fs-18 mb-2">Apple
                                                        School & College</h6>
                                                </a>
                                                <p class="text-muted mb-4">Canada</p>
                                                <!-- <a href="company-details.html"
                                                    class="btn btn-primary">27
                                                    Opening Jobs</a> -->
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card text-center mb-4">
                                        <div class="card-body px-4 py-5">
                                            ...
                                            <div class="mt-4">
                                                <a href="company-details.html"
                                                    class="primary-link">
                                                    <h6 class="fs-18 mb-2">Hunter
                                                        Hospital</h6>
                                                </a>
                                                <p class="text-muted mb-4">America</p>
                                                <!-- <a href="company-details.html"
                                                    class="btn btn-primary">07
                                                    Opening Jobs</a> -->
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card text-center mb-4">
                                        <div class="card-body px-4 py-5">
                                            ...
                                            <div class="mt-4">
                                                <a href="company-details.html"
                                                    class="primary-link">
                                                    <h6 class="fs-18 mb-2">Kshop
                                                        Agency</h6>
                                                </a>
                                                <p class="text-muted mb-4">America</p>
                                                <!-- <a href="company-details.html"
                                                    class="btn btn-primary">14
                                                    Opening Jobs</a> -->
                                            </div>
                                        </div>
                                    </div>
